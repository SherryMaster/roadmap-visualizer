          ...
          <div className="w-1/2 p-6 overflow-y-auto border-r border-gray-200 dark:border-gray-700">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Select a template to quickly create a task with pre-filled
                content
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 p-2 rounded border">
                      {selectedTemplate.template.est_time.min_time.amount}{" "}
                      {selectedTemplate.template.est_time.min_time.unit} -{" "}
                      {selectedTemplate.template.est_time.max_time.amount}{" "}
                      {selectedTemplate.template.est_time.max_time.unit}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 p-3 rounded border max-h-48 overflow-y-auto">
                      <pre className="whitespace-pre-wrap font-mono text-xs">
                        {selectedTemplate.template.task_detail.content.substring(
                          0,
                          500
                        )}
                        {selectedTemplate.template.task_detail.content.length >
                          500 && "..."}
                      </pre>
                    </div>
                  </div>
